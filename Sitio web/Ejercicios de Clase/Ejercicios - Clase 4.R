...
saveRDS(Individual_t117,paste0(resultados.dir,"Base_formato_r.RDS"))
Base_RDS <- readRDS(paste0(resultados.dir,"Base_formato_r.RDS"))

#Levantar el  Excel llamado CANASTAS que se encuentra en la carpeta de Fuentes, utilizando un Objeto que contenga el directorio del archivo a levantar.
dir <- paste0(dirname(rstudioapi::getActiveDocumentContext()$path),"/")
bases.dir      <-  paste0(dirname(dir),"/Fuentes/")
resultados.dir <- paste0(dirname(dir),"/Resultados/")
Canastas <- read.xlsx(paste0(bases.dir,"CANASTAS.xlsx"))
