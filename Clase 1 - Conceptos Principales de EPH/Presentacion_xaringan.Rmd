...
__El objetvo general__ de la encuesta es el conocimiento de un aspecto de nuestra realidad: La inserción de la población en la estructura económico-social<sup>1</sup>.

Dicha inserción puede ser analizada desde tres ejes conceptuales:
...
- __Cambios:__ En 2003 se lleva adelante la reformulación de la encuesta, para pasar a ser un relevamiento contínuo: Trimestral, 4 por año.
...
- __Cobertura__: Principales aglomerados urbanos. Fue creciendo progresivamente desde la puntual hacia la continua, hasta llega a 31 aglomerados urbanos (todas las capitales de provincia + aquellos aglomerados con +100.000 habitantes.
 
    + Representa al 72% del total urbano
    + 62% del total pais
    + 1 vez al año se aplica al total urbano (90% del país)
    + Proyecto en etapa de pruebas: Extensión al total país (100%)
...
---
# Instrumento de medición: Cuestionario de vivienda

La encuesta consta de 3 cuestionarios:

--

1. __vivienda__. Definición: "cualquier recinto fijo o móvil que ha sido construído o adaptado para alojar personas. Las viviendas pueden ser particulares o colectivas. La EPH sólo encuesta las particulares.
...
---
# Instrumento de medición: Cuestionario de hogar

2. __Hogar__. Definición: "Persona o grupo de personas parientes o no, que viven bajo un mismo techo y comparten los gastos de alimentación
...
--
    ...
    * Principales dimensiones:
      ...
      + Características habitacionales
      + Caracetrísticas demográficas básicas
      + Características educacionales
...
Identificación del hogar: Jefe o jefa de hogar<sup>*</sup>.


.footnote[
[*][_Buscar bibliografía sobre jefe / jefa de hogar_].]

---
# Instrumentos de medición: Cuestionario Hogar. El jefe o la jefa de hogar
...
---
# Instrumento de medición: Cuestionario de individual

Todos los caminos conducen ~~a Roma~~ al Mapa temático de la EPH
