...
###Cambios de formato        
Suele ocurrir que uno trabaja importando bases de datos donde las variables temporales no traen con el formato necesario para trabjar con fechas en R, o bien el programa no puede codificarlas directametne como fechas. El paquete `lubridate` también tiene una serie de funciones que permiten lidiar con ello.    
